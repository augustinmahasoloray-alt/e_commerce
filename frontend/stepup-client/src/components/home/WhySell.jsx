...
const advantages = [
  { icon: Users, title: "Une audience exigeante", description: "Nos clients recherchent l'authenticité et la qualité. Exactement ce que vous proposez." },
  { icon: Sparkles, title: "Une vitrine premium", description: "Mettez en avant votre univers dans un écrin qui valorise votre travail." },
  { icon: LifeBuoy, title: "Un accompagnement sur mesure", description: "De l'intégration à la logistique, nous vous épaulons à chaque étape." },
  { icon: TrendingUp, title: "Une visibilité accrue", description: "Bénéficiez de notre marketing et de notre notoriété pour développer votre marque." },
];
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8 mb-16">
        {advantages.map(({ icon: Icon, title, description }) => (
          <div key={title}>
            ...
            <h3 className="font-headline text-base text-textColor mb-3">{title}</h3>
